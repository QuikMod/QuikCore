...
public final class QuikLoader {
	...
	@QuikConfigurable(key = "Enable JSON Writeback", category = QuikConfigCategory.CORE, comment = "Set to false to disable automatic JSON writeback.")
	private static boolean writeback = true;
	
	static {
		QuikCore.getConfig().addConfigurable(QuikLoader.class);
	}
