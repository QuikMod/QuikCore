/*
 */
package com.github.quickmod.quiklib.lang;
 ...
 * @author RlonRyan
 */
public class QuikTranslator {

	private final QuikTranslationAdapter adapter;

	public QuikTranslator(QuikTranslationAdapter adapter) {
