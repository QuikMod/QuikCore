...
import com.github.quickmod.quiklib.util.ReflectionHelper;
...
public class QuikConfig {
	...
	public boolean getBoolean(String name, QuikConfigCategory category, boolean defaultValue, String comment) {
		return this.provider.getBoolean(name, category.name(), defaultValue, comment);
	}

	public int getInt(String name, QuikConfigCategory category, int defaultValue, int minValue, int maxValue, String comment) {
		return this.provider.getInt(name, category.name(), defaultValue, minValue, maxValue, comment);
	}

	public float getFloat(String name, QuikConfigCategory category, float defaultValue, float minValue, float maxValue, String comment) {
		return this.provider.getFloat(name, category.name(), defaultValue, minValue, maxValue, comment);
	}

	public double getDouble(String name, QuikConfigCategory category, double defaultValue, double minValue, double maxValue, String comment) {
		return this.provider.getDouble(name, category.name(), defaultValue, minValue, maxValue, comment);
	}

	public String getString(String name, QuikConfigCategory category, String defaultValue, String comment) {
